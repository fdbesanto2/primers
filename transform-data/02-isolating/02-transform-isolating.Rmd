...
You can use the data in `luquillo_stem_random` to make graphs like this, which reveal the history of a tree-stem species.

```{r echo = FALSE, message = FALSE, warning = FALSE, out.width = "90%"}
stem_count <- luquillo_stem_random %>% 
  filter(status != "D") %>% 
